...
const MyWork = () => {
  return (
    <section className="bg-[#f8f2ea] py-8 sm:py-12 px-4 sm:px-6 lg:px-12 min-h-screen w-full">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12 sm:mb-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
            {[1, 2, 3, 4].map((index) => (
              <div
                key={index}
                className="aspect-square bg-gray-200 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group relative w-full"
              >
        ...
        <div className="mb-12 sm:mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[1, 2, 3].map((index) => (
              <div
                key={index}
                className="aspect-video bg-gray-900 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 group relative w-full"
              >
                {/* Hover background overlay */}
                <div className="absolute inset-0 bg-gradient-to-br from-black/10 to-black/30 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 rounded-lg"></div>
                <img
                ...
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center transition-all duration-300 z-20">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-white/90 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 relative z-30">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col items-center mb-6 sm:mb-8">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-red-600 rounded-full flex items-center justify-center mb-4 shadow-lg">
          ...
          <a
            ...
            className="inline-flex items-center space-x-2 sm:space-x-3 bg-red-600 text-white font-semibold py-3 px-6 sm:py-4 sm:px-8 rounded-full hover:bg-red-700 transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg relative group min-h-[48px]"
          >
