    ...
    <section className="bg-[#f8f2ea] py-8 sm:py-12 px-4 sm:px-6 lg:px-12 min-h-screen w-full">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight mb-4 text-black uppercase">
            SERVICES
          </h1>
          <h2 className="text-base sm:text-lg lg:text-xl font-medium text-black mb-3 max-w-4xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
          {packages.map((pkg, index) => (
            <div
              key={pkg.id}
              className="relative bg-[#f8f2ea] rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 sm:p-8 border border-black/5 w-full"
              style={{
            ...
            >
              ...
              <div className="text-center mb-6">
                ...
                <div className="text-3xl sm:text-4xl font-bold text-black mb-4">
                  {pkg.price}
                </div>
              </div>
              ...
              {/* CTA Button */}
              <button className="w-full bg-black text-[#f8f2ea] font-semibold py-3 px-6 rounded-full transition-all duration-300 hover:bg-black/90 hover:scale-105 active:scale-95 uppercase tracking-wide text-sm min-h-[48px]">
                Book Now
              </button>
            </div>
          ))}
        ...
        <div className="text-center">
          ...
          <button className="bg-black text-[#f8f2ea] font-semibold py-3 px-6 sm:py-4 sm:px-8 rounded-full hover:bg-black/90 transition-all duration-300 hover:scale-105 uppercase tracking-wide text-sm sm:text-base min-h-[48px]">
