...
const About = () => {
  return (
    <section className="bg-[#f8f2ea] flex items-center py-8 sm:py-12 px-4 sm:px-6 lg:px-12 min-h-screen w-full">
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
          ...
          {/* Right Side - Content */}
          <div className="space-y-6 sm:space-y-8 lg:pl-8 order-2 lg:order-2">
            {/* Name */}
            <div className="space-y-2">
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tight text-[#111] leading-none text-center lg:text-left">
                SHANMUKHA
              </h1>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-black tracking-tight text-[#111] leading-none text-center lg:text-left">
                KOSIREDDI
            ...
            {/* Bio Content */}
            <div className="space-y-4 sm:space-y-6 text-[#111] max-w-xl text-center lg:text-left">
